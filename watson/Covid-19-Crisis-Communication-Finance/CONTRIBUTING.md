...
When contributing a major change to this repository, please first discuss the change you wish to make via an [issue](contributing/ISSUES.md) or sending email to arun.wagle@ibm.com. Minor issues can simply be addressed by sending by a pull request.
...
reported by contacting the project team lead through email to arun.wagle@ibm.com. 
