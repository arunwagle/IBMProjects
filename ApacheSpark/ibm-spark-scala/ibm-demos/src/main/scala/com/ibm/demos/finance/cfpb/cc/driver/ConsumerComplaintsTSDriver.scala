package com.ibm.demos.finance.cfpb.cc.driver
...
object ConsumerComplaintsTSDriver {
  ...
  val MONGODB_OUTPUT_URI: String = "mongodb://cfpbAdmin:cfpbAdmin@aws-us-east-1-portal.19.dblayer.com:11490/CFPB.monthly_consumer_complaints_test"
  ...
  def main(args: Array[String]) {
    ...
    @transient val sparkConf = new SparkConf()
      .setAppName("Demo-ConsumerComplaintsTSDriver")
//      .setMaster("local[8]")
